...
BOOST_PYTHON_MODULE(Jawa)
{
    ...
    class_<Expr>("Expr", init<string>())
      ...
      .def("GetVal",&Expr::GetVal_py)
      .def("getExpressionTokens", &Expr::getExpressionTokens_py)
      .def("getExpressionTokens", &Expr::getExpressionTokens2_py)
      .def("getRPN"    , &Expr::getRPN_py)
      .def("infixToRPN", &Expr::infixToRPN_py)
      ;
    
    class_<Template>("Template", init<string>())
